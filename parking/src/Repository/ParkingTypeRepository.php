 ...
 */
class ParkingTypeRepository extends \Doctrine\ORM\EntityRepository
{
    use AttributesTrait;
    ...
    {   
        $result = NULL;
        $dql = "SELECT u  FROM AppParking\Entity\ParkingType u ".
               "WHERE u.id = '".$id."'";
        try{
            if($returnArray){
    ...
    {   
        ...
        try{
            $qb->select(array('u'))
               ->from('AppParking\Entity\ParkingType', 'u')
