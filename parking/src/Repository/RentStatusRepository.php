...
use AppParking\Entity\RentStatus;
 ...
 */
class RentStatusRepository extends \Doctrine\ORM\EntityRepository
{
    use AttributesTrait;
    ...
    {   
        $result = NULL;
        $dql = "SELECT u  FROM AppParking\Entity\RentStatus u ".
               "WHERE u.id = '".$id."'";
        try{
            if($returnArray){
    ...
    {   
        ...
        try{
            $qb->select(array('u'))
               ->from('AppParking\Entity\RentStatus', 'u')
