...
use AppParking\Entity\SectionType;
 ...
 */
class SectionTypeRepository extends \Doctrine\ORM\EntityRepository
{
    use AttributesTrait;
    ...
    {   
        $result = NULL;
        $dql = "SELECT u  FROM AppParking\Entity\SectionType u ".
               "WHERE u.id = '".$id."'";
        try{
            if($returnArray){
    ...
    {   
        ...
        try{
            $qb->select(array('u'))
               ->from('AppParking\Entity\SectionType', 'u')
