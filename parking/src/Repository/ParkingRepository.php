...
class ParkingRepository extends \Doctrine\ORM\EntityRepository
{
    ...
    {   
        $result = NULL;
        $dql = "SELECT u  FROM AppParking\Entity\Parking u ".
               "WHERE u.id = '".$id."'";
        try{
            if($returnArray){
    ...
    {   
        ...
        try{
            $qb->select(array('u'))
               ->from('AppParking\Entity\Parking', 'u')
    ...
    {   
        ...
        try{
            if(!isset($data['parkingType'])){
                throw new Exception("parkingType param is missing");
            }
            $parkingType = $em->find('AppParking\Entity\ParkingType',$data['parkingType']);
            $obj = new Parking();
            $obj->setName($data['name']);
            $obj->setDescription($data['description']);
            $obj->setParkingType($data['parkingType']);
